...
//        listToDo.add(new ItemToDo("A faire 1", 1, 0, false, "2020-09-05", getApplicationContext()));
//        listToDo.add(new ItemToDo("A faire 2", 3, 0, true, "2020-10-21", getApplicationContext()));
//        listToDo.add(new ItemToDo("A faire 3", 2, 0, false, "2020-11-19", getApplicationContext()));
//        listToDo.add(new ItemToDo("A faire 4", 2, 0, false, "2020-12-01", getApplicationContext()));
//        listToDo.add(new ItemToDo("A faire 5", 3, 0, true, "2021-02-22", getApplicationContext()));
//        listToDo.add(new ItemToDo("A faire 6", 1, 0, false, "2021-05-27", getApplicationContext()));
       ...
       // TextView tv_empty = findViewById(R.id.empty_view);
        ...
        DividerItemDecoration divider = new DividerItemDecoration(rv_toDo.getContext(), DividerItemDecoration.VERTICAL);
    ...
    private void addToDo() {
        ...
        startActivityForResult(i, CODE_ACTIVITY);
    }
    ...
    private void insertTodo(String v, int prior) throws ParseException {
        ...
        listToDo.add(new ItemToDo(v, prior +1, 0,false, formatter.format(date), getApplicationContext()));
